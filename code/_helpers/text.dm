...
/proc/generateRandomString(var/length_char)
	. = list()
	for(var/a in 1 to length_char)
		var/letter = rand(33,126)
		. += ascii2text(letter)
	. = jointext(.,null)

#define starts_with(string, substring) (copytext(string,1,1+length_char(substring)) == substring)
